...
public class FreezingRecipe implements Recipe<Container> {
    ...
    public static class Serializer implements RecipeSerializer<FreezingRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(AutomateEverything.MODID, "freezing");

        @Override
        public FreezingRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new FreezingRecipe(inputs, output, pRecipeId);
        }

        @Override
        public @Nullable FreezingRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
